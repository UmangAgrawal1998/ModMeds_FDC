...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Chemist Validate</a>
            </li>
          </ul>
        </div>
      </div>
 ...
 <section id="contact">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Let Me Find Out !</h2>
            ...
            <form name="sentMessage" id="contactForm" novalidate="novalidate">
              ...
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="presid" type="text" placeholder="Enter Prescription ID" required="required" data-validation-required-message="Please enter patient age">
                  <p class="help-block text-danger"></p>
                </div>
                <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>Patient ID</label>
                  <input class="form-control" id="pkey" type="text" placeholder="Enter Patient ID" required="required" data-validation-required-message="Please enter patient age">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-primary btn-xl" id="CheckButton">Check</button>
              </div>
            </form>
          </div>
        </div>
   ...
   const firestore = firebase.firestore();
    ...
    {
     var query=output.where("Prescription_no","==",Prescription_no);
